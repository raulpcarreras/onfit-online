...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Botón con variantes y tamaños del design system. El tema se cambia automáticamente desde el panel de controles de Storybook.',
      },
    },
  },
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="flex gap-3 flex-wrap">
          ...
          <Button {...args} variant="premium">Premium</Button>
          <Button {...args} variant="social">Social</Button>
