...
async function debugSupabaseRPC() {
    ...
    try {
        ...
        const triggerFunctions = ["get_table_triggers", "get_triggers", "table_triggers"];
        ...
        const sqlFunctions = ["exec_sql", "run_sql", "execute_sql", "sql_query"];
        ...
        for (const funcName of customFunctions) {
            try {
                ...
                if (funcName === "is_super_admin") {
                    ...
                    if (!error) {
                        console.log(
                            `  ✅ Función ${funcName} disponible, resultado:`,
                            data,
                        );
                    } else {
                    ...
                    if (!error && data) {
                        ...
                        console.log(
                            `  ❌ Función ${funcName} no disponible:`,
                            error?.message || "Sin datos",
                        );
                    }
                }
