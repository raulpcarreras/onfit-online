      ...
      <div className="sticky top-14 z-20 bg-card border border-border rounded-lg mb-6">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Ejercicio {currentExerciseIndex + 1} de {exercises.length} • Serie{" "}
          ...
          <div className="flex items-center gap-3">
            ...
            {sessionStatus === "pending" && (
              <Button onPress={startSession} className="px-4 py-2">
            ...
            {sessionStatus === "active" && (
              <Button variant="secondary" onPress={togglePause} className="px-4 py-2">
            ...
            {sessionStatus === "paused" && (
              <Button onPress={togglePause} className="px-4 py-2">
                <Play className="size-4" />
                Reanudar
              </Button>
            )}
        ...
        <div className="px-4 pb-4">
          <div className="flex justify-between text-sm text-muted-foreground mb-2">
            ...
            <div>
              {sessionProgress} / {totalSets} series
            </div>
          </div>
          <Progress value={progressPercentage} size="sm" animated />
        </div>
      </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    {!set.completed && index === currentSetIndex && (
                      <Button
                        onPress={() =>
                          completeSet(currentExercise.id, index, {
                            reps: 10,
                            weight: 80,
                            rpe: 8,
                          })
          ...
          {exercises.map((exercise, index) => (
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div
                    className={`size-8 rounded-full grid place-items-center text-sm font-medium ${
                      index === currentExerciseIndex
