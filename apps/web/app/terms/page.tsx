    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="prose prose-gray dark:prose-invert max-w-none">
          <h2 className="text-2xl font-bold text-foreground mb-6">Términos y Condiciones de ONFIT</h2>
          
          <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
            <Card className="p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">1. Aceptación de los Términos</h3>
              <p>
                Al acceder y utilizar la aplicación ONFIT, aceptas estar sujeto a estos términos y condiciones. 
            ...
            <Card className="p-6">
              ...
              <p>
                ONFIT es una plataforma de fitness que proporciona entrenamientos personalizados, seguimiento 
                de progreso y herramientas para alcanzar tus objetivos físicos. Nuestros servicios incluyen:
              </p>
            ...
            <Card className="p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">3. Cuentas de Usuario</h3>
              <p>
            ...
            <Card className="p-6">
              ...
              <p>
                Te comprometes a utilizar ONFIT únicamente para fines legales y de acuerdo con estos términos. 
                No debes:
              </p>
              <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <Card className="p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">5. Privacidad y Datos</h3>
              <p>
                Tu privacidad es importante para nosotros. Recopilamos y utilizamos tu información personal 
                de acuerdo con nuestra Política de Privacidad. Al usar ONFIT, consientes la recopilación 
            ...
            <Card className="p-6">
              <h3 className="text-lg font-semibold text-foreground mb-3">8. Terminación</h3>
              <p>
                Podemos terminar o suspender tu cuenta en cualquier momento por violación de estos términos 
                o por cualquier otra razón a nuestra discreción. También puedes cancelar tu cuenta en cualquier momento.
              </p>
            </Card>
            ...
            <Card className="p-6">
              ...
              <p>
                ...
                o en la información de contacto proporcionada en el servicio.
              </p>
            </Card>
